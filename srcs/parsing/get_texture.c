...
/*   Updated: 2020/02/11 18:05:42 by akerdeka    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
int		get_texture_no(t_cub_struct *cub, char *line)
{
	...
	cub->tex_no[0] = ft_strtok(line, " ,\t");
	cub->tex_no[1] = ft_strtok(NULL, " ,\t");
...
int		get_texture_so(t_cub_struct *cub, char *line)
{
	...
	cub->tex_so[0] = ft_strtok(line, " ,\t");
	cub->tex_so[1] = ft_strtok(NULL, " ,\t");
...
int		get_texture_we(t_cub_struct *cub, char *line)
{
	...
	cub->tex_we[0] = ft_strtok(line, " ,\t");
	cub->tex_we[1] = ft_strtok(NULL, " ,\t");
...
int		get_texture_ea(t_cub_struct *cub, char *line)
{
	...
	cub->tex_ea[0] = ft_strtok(line, " ,\t");
	cub->tex_ea[1] = ft_strtok(NULL, " ,\t");
...
int		get_texture_sprite(t_cub_struct *cub, char *line)
{
	...
	cub->tex_sprite[0] = ft_strtok(line, " ,\t");
	cub->tex_sprite[1] = ft_strtok(NULL, " ,\t");
